...
def get_base_AL_mapping():
  from src.baselines.sampling_methods.margin_AL import MarginAL
  from src.baselines.sampling_methods.informative_diverse import InformativeClusterDiverseSampler
  from src.baselines.sampling_methods.hierarchical_clustering_AL import HierarchicalClusterAL
  from src.baselines.sampling_methods.uniform_sampling import UniformSampling
  from src.baselines.sampling_methods.represent_cluster_centers import RepresentativeClusterMeanSampling
  from src.baselines.sampling_methods.graph_density import GraphDensitySampler
...
def get_all_possible_arms():
  from src.baselines.sampling_methods.mixture_of_samplers import MixtureOfSamplers
...
def get_wrapper_AL_mapping():
  ...
  from src.baselines.sampling_methods.simulate_batch import SimulateBatchSampler
